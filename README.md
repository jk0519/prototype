...
The first serve is yours. Move freely behind the baseline with **A/D**. **Hold X** to raise the ball and charge a longer forward toss, adjust its height with **W/S** or the up/down arrows, then **release X** to throw it. The ball remains in the athlete's displayed hand until release. Movement stays active while X is held and during the throwing motion, so you can build a run-up before the ball leaves your hand. Press **Z** to plant and jump as the ball starts descending, then press **Z again** when it reaches your striking hand. Tossing does not jump automatically. An untouched toss loses the point; the serve must be hit in the air. After serving, move into the court. For an attack, approach the net on your side, jump as your setter's ball rises, then press Z again when the ball reaches your hand. Moving toward the net as you hit aims the spike shorter; moving away aims deeper. Hold Space before a low ball arrives to pass it to the setter.
...
- Adjustable jump serves with a low carry, visible palm raise, exact hand-attached release, displayed parabola, movable charge and windup, approach, foot plant, takeoff, timed contact, follow-through, and landing compression. AI servers use the same mechanics.
