...
Fast attacks add long ball streaks, player motion lines, swing arcs, radial contact bursts, camera velocity look-ahead, punch zoom, and a brief impact hold. Spikes use a much faster attack arc; blocks preserve most incoming horizontal speed while reversing it and driving the ball down. Turning off impact effects also turns off the hold, shake, and punch zoom. These effects change presentation timing only; match time and ball physics remain deterministic.
