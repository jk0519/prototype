# Kinetic player update validation

Engine: Godot **4.7.2.stable.official.ed1daf0bf**. Build: **SIDEOUT 0.3.0**. Development host: Apple Silicon Mac.
...
- Three seeded AI matches finish at the faster movement settings with receives, sets, spikes, blocks, free balls, net contacts, and multi-contact rallies. Results: 5–15 (22-contact longest rally), 15–11 (25), and 11–15 (22).
...
This is still an arcade prototype with procedural art rather than authored sprite sheets. A human playtest is needed to tune the faster movement, impact hold, camera acceleration, serve timing window, relative sound levels, and AI difficulty by feel. The wordless crowd recording is a generic anticipation/reaction sound, not audio copied from The Spike or a recording of a specific Japanese chant.
