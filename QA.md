...
Engine: Godot **4.7.2.stable.official.ed1daf0bf**. Build: **SIDEOUT 0.10.0**. Development host: Apple Silicon Mac.
...
- Three seeded AI matches finish with receives, oversized sets, high attacks, occasional blocks, emergency dives, and multi-contact rallies. Results: 15–9 (23-contact longest rally), 15–7 (25), and 16–14 (16).
...
- The player renderer was checked at ready, aim, plant, jump, contact, follow-through, block, jump-set, and dive poses. All six athletes stay small and faceless; role tags were removed so team color and pose carry the play. Fast movement adds lean, squash and stretch, rise lines, swing arcs, afterimages, and landing shocks.
- A fixed-step 60 FPS gameplay capture covers 721 consecutive rendered frames. Frame-sequence review confirms rapid approach strides, compressed plants, oversized takeoff, distinct airborne swing poses, held hand-to-ball contact, loose follow-through, accelerated recovery, high sets, dive extension, ball smears, camera punches, and contact effects that dominate the small characters.
